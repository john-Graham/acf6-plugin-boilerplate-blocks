 ...
 */
// add_filter( 'acf/settings/show_admin', 'acf_plugin_show_acf_admin' );
/**
 * Filters the settings to pass to the block editor for all editor type.
 * @link https://developer.wordpress.org/reference/hooks/block_editor_settings_all/
 */
// add_filter( 'block_editor_settings_all', 'acf_plugin_restrict_locking_ui', 10, 2 );
 ...
 * @since 0.1.2
 */
// function acf_plugin_show_acf_admin() {
...
// 	$settings['canLockBlocks'] = acf_plugin_show_admin();
